...
for (r in 1:iter) {
  iterpath = paste0(getwd(),"/diclinear",r)
  ...
  model = bugs(data, inits, parameters, model.file = paste0(getwd(),"/../model_linear.txt"), 
...
save(resultlst, file = paste0(getwd(),'/diclinear-', timestamp, ".RData"))
