...
for(t in 1:iter){
  ...
  model=bugs(data,inits,parameters,model.file="D:/simulation/model.txt",n.chains=2,n.iter = 3000,n.burnin = 1000,n.thin=1,bugs.directory = "D:/WinBUGS14/",working.directory = "D:/simulation/")
